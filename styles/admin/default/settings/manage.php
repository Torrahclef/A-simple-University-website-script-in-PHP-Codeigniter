...
<div class="form-group">
                                <label class="col-sm-2 control-label"><?php echo lang('settings_name') ?></label>
                                <div class="col-sm-10">
                                    <?php echo form_input('setting[name]', set_value('setting[name]', $item->name), 'class="bg-focus form-control" data-required="true" id="name"') ?>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Mission & Vision</label>
                                <div class="compose-message-editor col-sm-10">
                                    <textarea style="height: 150px;" class="form-control" name="setting[description]" id="editor1"><?php echo set_value('setting[description]', $item->description) ?></textarea>
                                </div>
                            </div>
                            <div class="form-group-separator"></div>
