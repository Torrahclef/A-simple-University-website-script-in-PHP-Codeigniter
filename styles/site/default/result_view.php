<div class="wrapper wrapper-breadcrumbs">
	<div class="academia-breadcrumbs">
		<p class="crumbs"><a href="<?php echo site_url() ?>"><?php echo lang('global_home'); ?></a> <span class="separator"> / </span> <span class="current"><?php echo lang('global_search_result'); ?></span></p>
	...
	<div class="wrapper wrapper-content-main">
		...
		<div class="academia-column academia-column-main academia-column-marginright">
			...
			<div class="post-meta-single">
				<h1 class="title title-l title-post-single"><?php echo lang('global_search_result'); ?></h1>
							</div><!-- end .post-meta -->
