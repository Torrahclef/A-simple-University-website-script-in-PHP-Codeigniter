<div class="wrapper wrapper-breadcrumbs">
	<div class="academia-breadcrumbs">
		<p class="crumbs"><a href="<?php echo site_url() ?>"><?php echo lang('global_home'); ?></a> <span class="separator"> / </span> <span class="current"><?php echo lang('global_upcoming_events'); ?></span></p>
...
<div id="content">
	...
	<div class="wrapper wrapper-content-main">
		...
		<div class="academia-column academia-column-main academia-column-marginright">
			...
			<div class="post-meta-single">
				<h1 class="title title-l title-post-single"><?php echo lang('global_upcoming_events'); ?></h1>
							</div><!-- end .post-meta -->
 ...
 <?php if(is_array($items)): ?>
	...
	<li class="academia-post academia-loop-post post-266 post type-post status-publish format-standard has-post-thumbnail hentry category-videos academia-event">
	<div class="post-cover">
		...
		<div class="post-content">
			...
			<h2 class="title-ms title-post"><a href="<?php echo site_url('eventpost/index/' . $item->event_id) ?>" title="<?php echo $item->title ?>"><?php echo $item->title ?></a></h2>
			<p class="post-excerpt"> <?php $this->load->helper('text') ?>
                                        <?php echo word_limiter($item->description, 10) ?> </p></p>
               </div><!-- .post-content -->
